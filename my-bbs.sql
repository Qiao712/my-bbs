...
CREATE TABLE `t_attachment` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `question_id` bigint unsigned NOT NULL COMMENT '指向贴子',
...
INSERT INTO `t_authority` VALUES (1,'修改板块','admin:forum:update','板块管理',NULL,_binary '','2022-08-29 16:03:51','2022-09-01 23:29:03'),(2,'添加角色','admin:role:add','角色管理','添加角色',_binary '','2022-08-29 16:03:51','2022-08-30 11:44:59'),(4,'删除评论','admin:comment:remove','评论管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 11:46:48'),(5,'修改板块logo','admin:forum:logo:update','板块管理',NULL,_binary '','2022-08-29 16:03:51','2022-09-01 23:29:09'),(6,'获取统计信息','admin:statistic:get','统计',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 11:47:16'),(7,'更新用户状态','admin:user:status:update','用户管理','更新用户状态(启用/禁用)',_binary '','2022-08-29 16:03:51','2022-08-30 12:25:35'),(9,'评论列表','admin:comment:list','评论管理','列出所有评论',_binary '','2022-08-29 16:03:51','2022-08-30 12:26:01'),(12,'修改角色','admin:role:update','用户管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 12:27:59'),(13,'修改用户','admin:user:update','角色管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 12:28:03'),(14,'角色列表','admin:role:list','角色管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 12:28:31'),(15,'添加板块','admin:forum:add','板块管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 12:28:40'),(16,'修改用户','admin:user::update','用户管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-31 21:57:10'),(17,'删除贴子','admin:question:remove','贴子管理',NULL,_binary '','2022-08-29 16:03:51','2022-08-30 12:29:26'),(21,'获取角色','admin:role:get','角色管理',NULL,_binary '','2022-08-29 21:38:37','2022-08-30 12:29:38'),(22,'权限列表','admin:authority:list','角色管理',NULL,_binary '','2022-08-29 21:38:37','2022-08-30 12:29:52'),(23,'修改权限','admin:authority:update','角色管理',NULL,_binary '','2022-08-30 10:55:04','2022-08-30 12:30:11'),(24,'板块分类列表','admin:forum:category:list','板块管理',NULL,_binary '','2022-08-30 12:35:18','2022-08-30 12:36:04'),(25,'添加广告','admin:sys:ads:add','广告管理','添加首页走马灯广告',_binary '','2022-08-31 14:42:59','2022-08-31 21:57:56'),(26,'修改广告','admin:sys:ads:update','广告管理',NULL,_binary '','2022-08-31 14:42:59','2022-08-31 21:58:15'),(27,'删除广告','admin:sys:ads:remove','广告管理',NULL,_binary '','2022-08-31 14:42:59','2022-08-31 21:58:24'),(28,'删除权限','admin:authority:remove','角色管理','删除失效权限',_binary '','2022-08-31 21:55:02','2022-08-31 21:58:56'),(29,'删除角色','admin:role:remove','角色管理',NULL,_binary '','2022-08-31 22:12:23','2022-08-31 22:12:36'),(30,'设置头像','user:set-avatar','用户',NULL,_binary '','2022-09-01 23:13:09','2022-09-01 23:27:15'),(31,'贴子点赞','question:like','贴子',NULL,_binary '','2022-09-01 23:13:09','2022-09-01 23:22:38'),(32,'板块列表','forum:list','板块',NULL,_binary '','2022-09-01 23:13:09','2022-09-01 23:20:04'),(33,'评论查看','comment:list','评论','查看贴子中的评论',_binary '','2022-09-01 23:13:09','2022-09-01 23:16:53'),(34,'我的评论列表','comment:list:mine','评论','查看该用户所发表评论',_binary '','2022-09-01 23:13:09','2022-09-01 23:17:38'),(35,'删除所发贴子','question:remove:mine','贴子',NULL,_binary '','2022-09-01 23:13:09','2022-09-01 23:23:00'),(36,'用户注册','user:register','用户','注册用户',_binary '','2022-09-01 23:13:09','2022-09-01 23:26:43'),(37,'删除所发评论','comment:remove:mine','评论','删除该用户所发表的评论',_binary '','2022-09-01 23:13:09','2022-09-01 23:18:16'),(38,'评论点赞','comment:like','评论','',_binary '','2022-09-01 23:13:09','2022-09-01 23:18:31'),(39,'获取板块','forum:get','板块','',_binary '','2022-09-01 23:13:09','2022-09-01 23:20:16'),(40,'贴子列表','question:list','贴子','板块中的贴子列表',_binary '','2022-09-01 23:13:09','2022-09-01 23:23:36'),(41,'用户列表','user:lists','用户','',_binary '','2022-09-01 23:13:09','2022-09-01 23:27:06'),(42,'查看贴子','question:get','贴子','查看贴子内容',_binary '','2022-09-01 23:13:09','2022-09-01 23:24:21'),(43,'贴子搜索','question:search','贴子','',_binary '','2022-09-01 23:13:09','2022-09-01 23:24:55'),(44,'发表评论','comment:add','评论','',_binary '','2022-09-01 23:13:09','2022-09-01 23:18:48'),(45,'发帖','question:add','贴子',NULL,_binary '','2022-09-01 23:13:09','2022-09-01 23:25:06'),(46,'发送私信','message:send','消息','',_binary '\0','2022-09-01 23:13:09','2022-09-01 23:20:54'),(47,'获取用户','user:get','用户',NULL,_binary '','2022-09-01 23:13:09','2022-09-01 23:27:24'),(48,'上传贴子中插图','question:image:upload','贴子','上传图片以在贴子内容中引用',_binary '','2022-09-01 23:13:09','2022-09-01 23:26:07'),(49,'私信查看','message:private:list','消息','',_binary '\0','2022-09-01 23:13:09','2022-09-01 23:21:34'),(50,'会话列表','message:conversation:list','消息','',_binary '\0','2022-09-01 23:13:09','2022-09-01 23:21:51'),(51,NULL,'chat:private:list',NULL,NULL,_binary '','2022-10-22 19:40:35',NULL),(52,NULL,'chat:conversation:list',NULL,NULL,_binary '','2022-10-22 19:40:36',NULL);
...
CREATE TABLE `t_comment` (
  ...
  `question_id` bigint unsigned NOT NULL COMMENT '所属贴子id',
  ...
  CONSTRAINT `fk_question_id` FOREIGN KEY (`question_id`) REFERENCES `t_question` (`id`) ON DELETE RESTRICT
...
INSERT INTO `t_message` VALUES (65,41,31,NULL,'Reply',_binary '','{\"authorId\":41,\"authorUsername\":\"user10\",\"comment\":\"测试子评论1-1\",\"commentId\":81,\"questionId\":16,\"questionTitle\":\"测试\"}','2022-10-21 19:01:31.868000',NULL);
...
CREATE TABLE `t_question` (
  ...
  KEY `idx_question_create_time` (`create_time` DESC),
...
CREATE TABLE `t_question_like` (
  ...
  KEY `fk_question_like_user_id_idx` (`user_id`),
  KEY `fk_liked_question_id_idx` (`question_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `fk_liked_question_id` FOREIGN KEY (`question_id`) REFERENCES `t_question` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_question_like_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户对贴子的点赞记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_question_like`
--

LOCK TABLES `t_question_like` WRITE;
/*!40000 ALTER TABLE `t_question_like` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_question_like` ENABLE KEYS */;
UNLOCK TABLES;
